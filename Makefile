...
#    Updated: 2023/10/20 22:23:52 by kscordel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = $(SRC_DIR)minishell.c $(SRC_DIR)lexer.c  $(SRC_DIR)utils.c $(SRC_DIR)utils2.c \
		...
		$(SRC_DIR)heredoc.c $(SRC_DIR)exec.c $(SRC_DIR)redirection.c \
		$(SRC_DIR)builtin1.c $(SRC_DIR)builtin2.c $(SRC_DIR)herdoc_expand.c \
		$(SRC_DIR)initshell.c $(SRC_DIR)signal.c \
		$(SRC_DIR)new_hexec.c $(SRC_DIR)new_heredoc.c $(SRC_DIR)new_redirection.c
